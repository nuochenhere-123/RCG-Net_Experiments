...
def getCIEDE(dir, image, x, y, L, a, b): 
    ...
    for i in range(0,10):
        ...
        print("{i}: 位置 [{x[i]}, {y[i]}] 的 RGB 值: {rgb_pixel},LAB值: L={lab_pixel[0]:.2f}, a={lab_pixel[1]:.2f}, b={lab_pixel[2]:.2f}")
...
if __name__ == '__main__':    
    ...
    # 读取图像
    dir = "./New4_2_C1"
    image1 = 'Cannon_D10_UW-Portrait_out.jpeg'  # 替换为你的图像路径
    x1 = [230, 237, 243, 253, 259, 230, 237, 245, 256, 264]
    y1 = [436, 438, 438, 436, 436, 444, 444, 443, 443, 443]
    CIEDE1 = getCIEDE(dir, image1, x1, y1, 37.99, 13.56, 14.06)
    
    print("CIEDE2000的均值为:", CIEDE1)
