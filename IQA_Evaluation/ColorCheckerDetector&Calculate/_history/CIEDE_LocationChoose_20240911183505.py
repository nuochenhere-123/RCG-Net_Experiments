...
if __name__ == '__main__':    
    ...
    # 读取图像
    image_path = './checker_input/Pentax_W80_UW-Portrait.jpeg'  # 替换为你的图像路径  New4_3_C6-checker\Cannon_D10_UW-Portrait_out.jpeg
    image_path = './checker_input/Pentax_W80_UW-Portrait.jpeg'
    ...
    hang = 0
    # 检查文件是否存在，若存在则删除
    if os.path.exists(os.path.join(dir, save_txt_name_X)):
        os.remove(os.path.join(dir, save_txt_name_X))
    if os.path.exists(os.path.join(dir, save_txt_name_Y)):
        os.remove(os.path.join(dir, save_txt_name_Y))
