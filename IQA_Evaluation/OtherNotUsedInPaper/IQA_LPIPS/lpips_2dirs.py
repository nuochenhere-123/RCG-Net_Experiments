...
parser.add_argument('-d0','--dir0', type=str, default='./img/Test/RetinexBased-110')
...
parser.add_argument('-o','--out', type=str, default='./img/Test/RetinexBased-110/RetinexBased-LPIPS-110.txt')
