...
if __name__ == '__main__':
    # 想要resize的图片路径
    resize_path = "./UWMamba-OceanDark-256"
    # resize_path = "./ZSRM-checker-256"
    resize_dirs = os.listdir(resize_path)
    # resize大小的参考图像路径
    # reference_path = "./UIEB-reference-890"
    reference_path = "./Size_Reference/Test-OceanDark"
    # resize 后保存路径
    save_dir = "./UWMamba-OceanDark-resize"
    # save_dir = "./ZSRM-checker-256-resize"
    ...
    for imgdir in resize_dirs:
        ...
        # if  imgdir.endswith('_out.png') or imgdir.endswith('_out.jpg') or imgdir.endswith('_out.jpeg'): # 文件后缀
            ...
            refname = imgname_cor+'.'+'jpg' # 参考图像名称（含后缀）随机应变改！！！
