...
if __name__ == '__main__':
    # 想要resize的图片路径
    # resize_path = "./PUGAN-110"
    resize_path = "./New4_4_C1_4-epoch200-256-checker"
    resize_dirs = os.listdir(resize_path)
    # resize大小的参考图像路径
    # reference_path = "./UIEB-reference-890"
    reference_path = "./Size_Reference/Test-checker"
    # resize 后保存路径
    # save_dir = "./PUGAN-110-resize"
    save_dir = "./New4_4_C1_4-256-checker-resize"
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)

    # 遍历 Test 文件夹下的所有子文件夹
    for data_dir, _, _ in os.walk(resize_dirs):
        N=0
