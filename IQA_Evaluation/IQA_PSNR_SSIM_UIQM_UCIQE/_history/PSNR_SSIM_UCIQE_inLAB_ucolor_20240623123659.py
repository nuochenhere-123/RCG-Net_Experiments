...
def main():
    ...
    for imgdir in result_dirs:
        ...
        if  imgdir.endswith('_out.png'): # 文件后缀   随机应变改！！！
            ...
            imagenum += 1
            # 保存文件名
            save_txt_name = 'upgrade2_3-Test-110 PSNR-{} & SSIM-{} & UIQM-{} & UCIQE-{}.txt'.format(psnr_str, ssim_str, uiqm_str, uciqe_str)
            save_txt_name = 'upgrade7_4-R90 PSNR-{} & SSIM-{} & UIQM-{} & UCIQE-{}.txt'.format(psnr_str, ssim_str, uiqm_str, uciqe_str)
