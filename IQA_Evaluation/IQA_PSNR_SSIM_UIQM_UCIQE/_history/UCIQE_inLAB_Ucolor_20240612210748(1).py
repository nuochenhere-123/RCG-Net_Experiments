...
def save_with_IQA(result_path,corrected,imgdir,uciqe_str):
        ...
        ex='Res_UCIQE_epoch56' # 文件夹名称
        # ex='upgrade6_3-U45-ep50' # 文件夹名称
...
def main():
    ...
    for imgdir in result_dirs:
        ...
        if  imgdir.endswith('_io.png'): # 文件后缀
            ...
            with open(os.path.join(result_path,'000UCIQE_epoch56.txt'), 'a') as f:
            # with open(os.path.join(result_path,'UCIQE-upgrade6_3-ep50-.txt'), 'a') as f:
                f.write('{}: uciqe={}\n'.format(imgdir,uciqe))
