...
def save_with_IQA(result_path,corrected,imgdir,psnr_str,ssim_str,uiqm_str,uciqe_str):
        # 计算完成后标有指标数值的图片存储路径
        ex='PSNR_SSIM_UIQM_UCIQE-upgrade7-Test-110-remark' # 文件夹名称
...
def main():
    ...
    # 重命名文件名
    save_txt_name_new = 'upgrade7-Test-110 PSNR-{} & SSIM-{} & UIQM-{} & UCIQE-{}.txt'.format(mpsnr_str, mssim_str, muiqm_str, muciqe_str)
