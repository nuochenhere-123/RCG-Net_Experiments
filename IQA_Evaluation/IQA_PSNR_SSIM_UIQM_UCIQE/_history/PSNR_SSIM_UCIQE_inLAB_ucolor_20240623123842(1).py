...
def main():
 ...
 # 保存文件名
     = 'upgrade2_3-Test-110 PSNR-{} & SSIM-{} & UIQM-{} & UCIQE-{}.txt'.format(psnr_str, ssim_str, uiqm_str, uciqe_str)
     = 'upgrade7_4-R90 PSNR-{} & SSIM-{} & UIQM-{} & UCIQE-{}.txt'.format(psnr_str, ssim_str, uiqm_str, uciqe_str)
