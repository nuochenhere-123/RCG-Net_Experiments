...
parser.add_argument('--hazydir', default='./Data/ReTrain/raw-780/')
parser.add_argument('--cleandir', default='./Data/ReTrain/reference-780/')

parser.add_argument('--checkpoints_dir', default='./ckpts_ReTrain/')
parser.add_argument('--batch_size', type=int, default=5) # train
parser.add_argument('--num_images', type=int, default=780)
...
parser.add_argument('--testing_dir_inp', default="./Data/ReTrain_Test/DICAM-C60/")
parser.add_argument('--testing_dir_gt', default="./Data/UIEB/reference-780/")
