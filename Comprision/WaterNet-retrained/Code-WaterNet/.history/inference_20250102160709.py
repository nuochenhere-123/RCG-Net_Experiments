# python inference.py --source data/example/173.jpeg --weights training/0/last.pt
# 测试如下：
# python inference.py --source ./Test-110 --weights training/ReTrain_try/last.pt  --name WaterNet-ReTrain-110
import argparse
...
outputdir = wd / "WaterNet-ReTrain-output"
