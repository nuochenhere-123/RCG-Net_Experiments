# 训练参数  https://github.com/tnwei/waternet
import torch
import torchvision
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epochs", type=int, default=160, help="(Optional) Num epochs, defaults to 160"
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    dataset = UIEBDataset(
        projectroot / "data/raw-780",
        projectroot / "data/reference-780",
        im_height=im_height,
        im_width=im_width,
    )
    train_dataset, val_dataset = torch.utils.data.random_split(dataset, [720, 60])
