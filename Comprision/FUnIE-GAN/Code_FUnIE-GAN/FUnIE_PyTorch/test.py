...
parser.add_argument("--data_dir", type=str, default="data/test/Test-UIQS/")
parser.add_argument("--sample_dir", type=str, default="data/output256/FUnIE-UIQS")
# parser.add_argument("--sample_dir", type=str, default="data/output-ToResize/FUnIE-110")
parser.add_argument("--model_name", type=str, default="funiegan") # or "ugan"
parser.add_argument("--model_path", type=str, default="checkpoints_reTrain/FunieGAN/UIEB780/generator_200.pth")
...
for path in test_files:
    ...
    # 近似尺寸 输入输出
    img_width, img_height = inp_img.size
    transforms_ = [transforms.CenterCrop((img_height - img_height % 32, img_width - img_width % 32)),  # 确保图像尺寸是32的倍数
          transforms.ToTensor(),
          transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),]
    transform = transforms.Compose(transforms_)
    # 近似尺寸 输入输出
